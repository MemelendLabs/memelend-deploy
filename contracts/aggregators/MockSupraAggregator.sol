...
contract MockSupraAggregator is Ownable, AggregatorInterface {
    ...
    function latestAnswer() external view returns (int256) {
        ...
        return SafeCast.toInt256(convertToUsd(priceFeed.price, priceFeed.decimals));
    }
    ...
    function convertToUsd(uint256 price, uint256 priceDecimals) internal view returns (uint256) {
        ...
        ISupraSValueFeed.priceFeed memory usdtFeed =
            ISupraSValueFeed.priceFeed({round: 1, decimals: 8, time: 1, price: 100000000});
